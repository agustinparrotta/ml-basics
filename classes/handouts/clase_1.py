...
#       existencia de nuevos datos para volver a aplicar el workflow.
...
# %%
# -- Entrenamiento sobre dataset completo para puesta en producción --
...
# %%
# -- Realización de una predicción de ejemplo con el modelo entrenado --
